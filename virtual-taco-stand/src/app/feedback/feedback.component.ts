...
export class FeedbackComponent {
  ...
  constructor(private fb: FormBuilder){
      this.preexistingFeedback=[
        ...
        recommend: 'Yes',
        comments: 'Absolutely loved everything! Great value for the money spent and the staff is friendly.'
        }
      ];
    }
    ...
    leaveFeedback(){
      ...
      .map((likes,index)=> selectedLikesValues[index]? likes:null)
      ...
      //Now, selectedLike contain the actual items that were selected
      console.log('Selected likes:', selectedLikes);
      console.log('Complete from value:', newFeedback);
